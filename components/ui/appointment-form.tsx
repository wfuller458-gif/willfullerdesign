...
export const AppointmentForm: React.FC<AppointmentFormProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="appointmentStroke" x1="0%" y1="0%" x2="0%" y2="100%">
      ...
      >
        ...
        >
          ...
          >
            Let's explore your ideas in more detail. Book a free 30-minute consultation whenever suits you.
          </p>
        </div>
