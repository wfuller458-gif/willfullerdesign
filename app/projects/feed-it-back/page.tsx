      ...
      >
        ...
        >
          ...
          <div className="project-column" style={{ flex: 1, maxWidth: '600px' }}>
            ...
            >
              In 2020, I worked as a freelance designer with Full Clarity, a design agency based in Surrey, on a project for Feed It Back a case management platform used by large restaurant chains such as PizzaExpress, TGI Fridays, and Las Iguanas.
            </p>
            ...
            >
              Full Clarity led the discovery phase, conducting user research with existing customers through interviews. The findings were synthesised into a research document outlining key workflows, recurring pain points, and opportunities for improvement. This document formed the foundation for the design work.
            </p>
          </div>
        </div>
        ...
        >
          <img
            src="/images/projects/feed-it-back/image-1.png"
            alt="Feed It Back Interface"
            style={{
              width: '100%',
              height: '100%',
              objectFit: 'cover',
        ...
        >
          ...
          >
            This inbox aggregates reviews and feedback from multiple platforms, including Facebook, Instagram, Twitter, and TripAdvisor, into a single interface.
          </p>
        </div>

        {/* Full-Width Image - 832px */}
        <div
        ...
        >
          <img
            src="/images/projects/feed-it-back/image-2.png"
            alt="Feed It Back Inbox Interface"
            style={{
              width: '100%',
              height: '100%',
              objectFit: 'cover',
        ...
        {/* Final Text Section - Inbox Requirements */}
        <div
          ref={textSection2Ref}
          className="project-content-padding project-section-spacing"
          style={{
        ...
        >
          ...
          >
            The inbox is a dense, high-stakes environment designed for operational teams. Users need to:
          </p>
          ...
          >
            <li>Read and respond directly to every review</li>
            <li>Prioritise and flag critical issues (e.g. food poisoning or serious complaints)</li>
            <li>Manage large volumes of incoming feedback efficiently</li>
            <li>Use templates to automate common responses</li>
            <li>Issue compensation, such as vouchers, directly from the inbox</li>
          </ul>
