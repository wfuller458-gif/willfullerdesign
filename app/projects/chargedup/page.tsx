...
export default function ChargedUpProject() {
      ...
      >
        ...
        >
          ...
          <div className="project-column" style={{ flex: 1, maxWidth: '600px' }}>
            ...
            >
              I joined ChargedUp in 2018 as a creative design intern, becoming one of the first interns to work directly with the four founders at the very start of the company's journey.
            </p>
            ...
            >
              This was an early, hands-on stage of the business just as ChargedUp's first shipment of charging stations arrived from the manufacturer and was being prepared for installation across venues in London.
            </p>
          </div>
        </div>
        ...
        >
          <img
            src="/images/projects/chargedup/image-1.png"
            alt="ChargedUp Charging Station"
            style={{
              width: '100%',
              height: '100%',
              objectFit: 'cover',
        ...
        >
          ...
          >
            As part of a small founding team, I contributed wherever support was needed across design, product, and marketing. My work included:
          </p>
          ...
          >
            <li>Creating a CAD model of the charging station</li>
            <li>Producing high-quality product renders</li>
            <li>Designing pitch and investment decks</li>
            <li>Preparing assets for print</li>
            <li>Creating creative for Facebook and Instagram ads</li>
            <li>Designing and building website landing pages</li>
          </ul>
          ...
          >
            Working so closely with the founders gave me exposure to the full lifecycle of an early stage startup from product visualisation to investor storytelling and customer acquisition.
          </p>
        </div>
      </div>
